...
public class TransacaoUpdateRequestDTO {
    ...
    public TransacaoUpdateRequestDTO(BigDecimal valor, String descricao, LocalDate data, Status status, Integer usuarioId, Integer categoriaId, List<Integer> metasId) {
        this.valor = valor;
